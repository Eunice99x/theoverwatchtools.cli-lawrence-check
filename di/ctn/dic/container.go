...
//
// If the object can not be retrieved, it returns an error.
func (c *Container) SafeGetLogicCapturePages() (*capturepagelogic.Service, error) {
	i, err := c.ctn.SafeGet("logic_capture_pages")
	if err != nil {
		var eo *capturepagelogic.Service
		return eo, err
	}
	o, ok := i.(*capturepagelogic.Service)
	if !ok {
		return o, errors.New("could get 'logic_capture_pages' because the object could not be cast to *capturepagelogic.Service")
	}
	return o, nil
}
...
//
// If the object can not be retrieved, it panics.
func (c *Container) GetLogicCapturePages() *capturepagelogic.Service {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it returns an error.
func (c *Container) UnscopedSafeGetLogicCapturePages() (*capturepagelogic.Service, error) {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it panics.
func (c *Container) UnscopedGetLogicCapturePages() *capturepagelogic.Service {
...
// If the container can not be retrieved, it panics.
func LogicCapturePages(i interface{}) *capturepagelogic.Service {
