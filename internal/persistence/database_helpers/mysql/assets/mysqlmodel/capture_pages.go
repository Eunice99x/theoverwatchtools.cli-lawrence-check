...
type CapturePage struct {
	...
	IsControl        bool      `boil:"is_control" json:"is_control" toml:"is_control" yaml:"is_control"`
	CapturePageSetID uint64    `boil:"capture_page_set_id" json:"capture_page_set_id" toml:"capture_page_set_id" yaml:"capture_page_set_id"`
	CreatedBy        uint      `boil:"created_by" json:"created_by" toml:"created_by" yaml:"created_by"`
	UpdatedBy        uint      `boil:"updated_by" json:"updated_by" toml:"updated_by" yaml:"updated_by"`
...
var CapturePageWhere = struct {
	...
	IsControl        whereHelperbool
	CapturePageSetID whereHelperuint64
	CreatedBy        whereHelperuint
	UpdatedBy        whereHelperuint
	...
	ID:               whereHelperuint{field: "`capture_pages`.`id`"},
	...
	IsControl:        whereHelperbool{field: "`capture_pages`.`is_control`"},
	CapturePageSetID: whereHelperuint64{field: "`capture_pages`.`capture_page_set_id`"},
	CreatedBy:        whereHelperuint{field: "`capture_pages`.`created_by`"},
	UpdatedBy:        whereHelperuint{field: "`capture_pages`.`updated_by`"},
...
type (
	...
	// CapturePageHook is the signature for custom CapturePage hook methods
	CapturePageHook func(context.Context, boil.ContextExecutor, *CapturePage) error
...
var capturePageAfterSelectMu sync.Mutex
var capturePageAfterSelectHooks []CapturePageHook

var capturePageBeforeInsertMu sync.Mutex
var capturePageBeforeInsertHooks []CapturePageHook
var capturePageAfterInsertMu sync.Mutex
var capturePageAfterInsertHooks []CapturePageHook

var capturePageBeforeUpdateMu sync.Mutex
var capturePageBeforeUpdateHooks []CapturePageHook
var capturePageAfterUpdateMu sync.Mutex
var capturePageAfterUpdateHooks []CapturePageHook

var capturePageBeforeDeleteMu sync.Mutex
var capturePageBeforeDeleteHooks []CapturePageHook
var capturePageAfterDeleteMu sync.Mutex
var capturePageAfterDeleteHooks []CapturePageHook

var capturePageBeforeUpsertMu sync.Mutex
var capturePageBeforeUpsertHooks []CapturePageHook
var capturePageAfterUpsertMu sync.Mutex
var capturePageAfterUpsertHooks []CapturePageHook

// doAfterSelectHooks executes all "after Select" hooks.
func (o *CapturePage) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageAfterSelectHooks {
...
func (o *CapturePage) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageBeforeInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *CapturePage) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range capturePageAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddCapturePageHook registers your hook function for all future operations.
func AddCapturePageHook(hookPoint boil.HookPoint, capturePageHook CapturePageHook) {
	switch hookPoint {
	case boil.AfterSelectHook:
		capturePageAfterSelectMu.Lock()
		capturePageAfterSelectHooks = append(capturePageAfterSelectHooks, capturePageHook)
		capturePageAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		capturePageBeforeInsertMu.Lock()
		capturePageBeforeInsertHooks = append(capturePageBeforeInsertHooks, capturePageHook)
		capturePageBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		capturePageAfterInsertMu.Lock()
		capturePageAfterInsertHooks = append(capturePageAfterInsertHooks, capturePageHook)
		capturePageAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		capturePageBeforeUpdateMu.Lock()
		capturePageBeforeUpdateHooks = append(capturePageBeforeUpdateHooks, capturePageHook)
		capturePageBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		capturePageAfterUpdateMu.Lock()
		capturePageAfterUpdateHooks = append(capturePageAfterUpdateHooks, capturePageHook)
		capturePageAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		capturePageBeforeDeleteMu.Lock()
		capturePageBeforeDeleteHooks = append(capturePageBeforeDeleteHooks, capturePageHook)
		capturePageBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		capturePageAfterDeleteMu.Lock()
		capturePageAfterDeleteHooks = append(capturePageAfterDeleteHooks, capturePageHook)
		capturePageAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		capturePageBeforeUpsertMu.Lock()
		capturePageBeforeUpsertHooks = append(capturePageBeforeUpsertHooks, capturePageHook)
		capturePageBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		capturePageAfterUpsertMu.Lock()
		capturePageAfterUpsertHooks = append(capturePageAfterUpsertHooks, capturePageHook)
		capturePageAfterUpsertMu.Unlock()
	}
}
...
func FindCapturePage(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*CapturePage, error) {
	...
	if err = capturePageObj.doAfterSelectHooks(ctx, exec); err != nil {
		return capturePageObj, err
	}
...
func (o CapturePageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if len(capturePageBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(capturePageAfterDeleteHooks) != 0 {
		for _, obj := range o {
...
func CapturePageExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
